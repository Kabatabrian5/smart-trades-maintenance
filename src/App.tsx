      ...
      {isCashierOpen && account && (
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/70 p-4" onClick={() => setIsCashierOpen(false)}>
          <section className="w-full max-w-md rounded-2xl border border-[#30303d] bg-[#17171f] p-6 text-white shadow-2xl" role="dialog" aria-modal="true" aria-labelledby="cashier-title" onClick={(event) => event.stopPropagation()}>
            ...
            <div className="mt-4 rounded-xl border border-amber-500/30 bg-amber-500/10 p-4 text-center"><p className="text-lg font-extrabold text-amber-300">Coming soon</p><p className="mt-2 text-xs leading-5 text-gray-400">Smart Trades cashier deposits and withdrawals are not available yet. Please use Deriv&apos;s official cashier to fund or withdraw from this account.</p><a href="https://app.deriv.com/cashier" target="_blank" rel="noreferrer" className="mt-4 inline-flex rounded-xl bg-emerald-500 px-4 py-2 text-xs font-bold text-[#071217] transition hover:bg-emerald-400">Open Deriv Cashier</a></div>
